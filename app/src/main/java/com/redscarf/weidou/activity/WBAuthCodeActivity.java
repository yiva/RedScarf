...
public class WBAuthCodeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化微博对象
        mAuthInfo = new AuthInfo(this, MyConstants.APP_KEY, MyConstants.REDIRECT_URL, MyConstants.SCOPE);
    ...
    public void fetchTokenAsync(String authCode, String appSecret) {
        ...
        WeiboParameters requestParams = new WeiboParameters(MyConstants.APP_KEY);
        requestParams.put(WBConstants.AUTH_PARAMS_CLIENT_ID,     MyConstants.APP_KEY);
        ...
        requestParams.put(WBConstants.AUTH_PARAMS_REDIRECT_URL,  MyConstants.REDIRECT_URL);
